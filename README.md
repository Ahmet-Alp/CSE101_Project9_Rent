# Vehicle Rental Management System - CSE101 Project

This is a terminal-based vehicle rental system. The project manages vehicle inventory, customer profiles, and rental reservations using Python and JSON for data storage.
...
AI Usage Statement: Artificial Intelligence (Gemini) was used during this project as a coding assistant. I generally followed the instructions that is given by AI to continue the project. Most of the specific parts I received sample codes from AI.
